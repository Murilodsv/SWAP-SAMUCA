subroutine ReadFile_samuca(task,           &
                    n_inte_host,    &
                    inte_host,      &
                    n_real_host,    &
                    real_host)
    ...
    integer     inte_host(n_inte_host)  ! Up to 300 parameters
    real        real_host(n_real_host)  ! Up to 300 parameters
...
50  continue 
    ...
    !
    !if(nlay .gt. 4)then
    !    write(warn,*) 'More than 4 layers provided for the standalone version. Only the top-4 layers will be used.'
    !endif   
    !
    !close(soil_io)   
...
60  continue
    ...
    open(crop_iunit,file='Samuca.par',status='old',action='read',iostat=ios)    
    !call checkios(ios,1)
...
!120 format(<nf-1>(f26.5,a30,/)    ,f26.5,a30)
    ...
    write(fmt_var,'("(", I0, "(/), ", I1, "(I26,a30,/))")') nhd,ni                      
    ...
    read (crop_iunit, fmt_var)                &
        ...
        real_host(108) , ignore, 	& ! (R)
        real_host(109) , ignore, 	& ! (R) Feddes parameters
        real_host(110) , ignore, 	& ! (R) Feddes parameters
        real_host(111) , ignore, 	& ! (R) Feddes parameters
        real_host(112) , ignore, 	& ! (R) Feddes parameters
        real_host(113) , ignore, 	& ! (R) Feddes parameters
        real_host(114) , ignore, 	& ! (R) Feddes parameters
        real_host(115) , ignore, 	& ! (R) Feddes parameters
        real_host(116) , ignore, 	& ! (R) Feddes parameters
        real_host(117) , ignore, 	& ! (R) Feddes parameters
        real_host(118)                ! (R) planting depth
...
70  continue    
    ...
    end subroutine ReadFile_samuca
